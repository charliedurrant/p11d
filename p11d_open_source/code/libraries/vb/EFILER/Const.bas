...
Public Enum ATCEFILER_ERRORS
  ERR_UNKNOWN = TCSBASE.ABATEC_EFILER + 1
  ERR_DSN
  ERR_WRONGKEY
...
' Live Constants
Public Const S_GG_LIVE_SUBMITADDRESS As String = "https://secure.gateway.gov.uk/submission/ggsubmission.asp"
Public Const S_GG_LIVE_POLLADDRESS As String = "https://secure.gateway.gov.uk/poll"
Public Const S_GG_LIVE_DELETEADDRESS As String = "https://secure.gateway.gov.uk/submission"
' Test constants
Public Const S_GG_TEST_SUBMITADDRESS As String = "https://secure.dev.gateway.gov.uk/submission/ggsubmission.asp"
Public Const S_GG_TEST_POLLADDRESS As String = "https://secure.dev.gateway.gov.uk/poll"
Public Const S_GG_TEST_DELETEADDRESS As String = "https://secure.dev.gateway.gov.uk/submission"
Public Const S_GG_TEST_TPVS_SITE_CT As String = "https://www.tpvstest.co.uk/CT600/post.slt"
Public Const S_GG_TEST_TPVS_SITE_P11D As String = "https://www.tpvstest.co.uk/EXB/post.slt"
...
Public Sub CloseRecordSet(ByVal rs As Recordset)
  On Error Resume Next
  If Not rs Is Nothing Then rs.Close
End Sub

Public Sub CloseConnection(ByVal cn As Connection)
  On Error Resume Next

...
Begin VB.UserControl UBGRD 
   ...
   Begin TrueOleDBGrid60.TDBGrid Grid_i 
      Height          =   1935
      Left            =   495
      OleObjectBlob   =   "TCSUBGR6.ctx":0000
      TabIndex        =   0
      Top             =   150
      Width           =   2535
   End
...
Public Event ReadData(RowBuf As TrueOleDBGrid60.RowBuffer, ByVal RowBufRowIndex As Long, ObjectList As ObjectList, ByVal ObjectListIndex As Long)
Public Event WriteData(ByVal RowBuf As TrueOleDBGrid60.RowBuffer, ByVal RowBufRowIndex As Long, ObjectList As ObjectList, ObjectListIndex As Long)
Public Event ValidateTCS(FirstColIndexInError As Long, ValidateMessage As String, ByVal RowBuf As TrueOleDBGrid60.RowBuffer, ByVal RowBufRowIndex As Long, ByVal ObjectListIndex As Long)
...
Private Sub grid_i_UnboundReadDataEx(ByVal RowBuf As TrueOleDBGrid60.RowBuffer, StartLocation As Variant, ByVal offset As Long, ApproximatePosition As Long)
...
Private Sub grid_i_UnboundAddData(ByVal RowBuf As TrueOleDBGrid60.RowBuffer, NewRowBookmark As Variant)
...
Private Sub grid_i_UnboundWriteData(ByVal RowBuf As TrueOleDBGrid60.RowBuffer, WriteLocation As Variant)
  Dim FirstColIndexInError As Long
...
Private Function GetObjectListIndex(oList As ObjectList, RowBuf As TrueOleDBGrid60.RowBuffer, StartLocation As Variant, ByVal offset As Long) As Long

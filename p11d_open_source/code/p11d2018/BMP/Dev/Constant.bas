...
Public Const S_EMPLOYEE_NUM_FIELD As String = "P_NUM"
Public Const STRYR2000 = "dd/mm/yyyy" ' cd/apf remove check

Public Const S_TELEPHONE As String = "(020) 7303 8122"
...
Public Const L_LOANDEMINIMUS As Long = 5000
...
Public Const S_CHK_PNUM As String = "PNUM"
Public Const S_CHK_REG As String = "REG"
...
Public Const S_PETROL As String = "(P)Petrol" 'SO
Public Const S_DIESEL As String = "(D)Diesel"
Public Const S_HYBRID As String = "(H)Hybrid electric"
Public Const S_ELECTRICITY As String = "(E)Electricity only"
Public Const S_BIFUEL_CO2_FOR_GAS As String = "(B)Bi-fuel, CO2 for gas"
Public Const S_BIFUEL_CONVERSION_OTHER_NOT_WITHIN_TYPE_B As String = "(C)Bi-fuel con,or other not within B"
Public Const S_GAS_ONLY As String = "(B)Gas only"
Public Const S_EUROIVDIESEL As String = "(L)Euro IV Diesel"

Public Const S_LPG As String = "LPG"
...
Public Const S_MNU_F12_PAYE_ONLINE_DISABLE_CHECK_SUBMISSION_WITH_ABATEC As String = "PAYE Online - Disable check submission with Abatec"
...
Public Const S_UDM_NIC_CLASS1A_VALUE As String = "Class 1A NIC(on gross)"
...
Public Const S_SERIAL_NUMBER_STANDARD = "P11DD847B378T4373475" 'Full functionality, all reports, emails etc.  Used for year-end (main) release.
Public Const S_SERIAL_NUMBER_INTRANET = "4687263T4S6P84662L05" 'As above with intranet publishing
Public Const S_SERIAL_NUMBER_SHORT = "P11DD8S4678V37746605" 'Reduced functionality (no printing (except P46, no employye letter etc.).  Used for b/f (minor) release.
Public Const S_SERIAL_NUMBER_UDM = "P11DD8U36V3774662005" 'Includes UDM mappings to Abacus
Public Const S_SERIAL_NUMBER_DEMO = "P11DD366O659V3774665" 'Full functionality available for both releases
...
Public Enum LICENCE_TYPE
  ...
  LT_UDM 'Includes UDM mappings to Abacus
...
Public Enum CHECKS
  ...
  CK_EC_NAME
  [_CK_ONLINE_START]
  CK_ONLINE_P11D = [_CK_ONLINE_START]
  CK_ONLINE_P46
  [_CK_LAST_ITEM] = CK_ONLINE_P46
End Enum

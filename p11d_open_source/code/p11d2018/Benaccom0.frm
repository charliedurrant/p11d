...
Begin VB.Form F_Accommodation 
   ...
   Begin TabDlg.SSTab tabAccom 
      ...
      Tab(0).Control(6)=   "Lab(2)"
      Tab(0).Control(6).Enabled=   0   'False
      Tab(0).Control(7)=   "TxtBx(7)"
      Tab(0).Control(7).Enabled=   0   'False
      Tab(0).Control(8)=   "TxtBx(2)"
      Tab(0).Control(8).Enabled=   0   'False
      Tab(0).Control(9)=   "TxtBx(8)"
      Tab(0).Control(9).Enabled=   0   'False
      Tab(0).Control(10)=   "TxtBx(15)"
      Tab(0).Control(10).Enabled=   0   'False
      Tab(0).Control(11)=   "TxtBx(19)"
      Tab(0).Control(11).Enabled=   0   'False
      Tab(0).Control(12)=   "TxtBx(20)"
      Tab(0).Control(12).Enabled=   0   'False
      Tab(0).Control(13)=   "ChkBx(4)"
      Tab(0).Control(13).Enabled=   0   'False
      Tab(0).Control(14)=   "ChkBx(0)"
      Tab(0).Control(14).Enabled=   0   'False
      Tab(0).Control(15)=   "ChkBx(1)"
      Tab(0).Control(15).Enabled=   0   'False
      Tab(0).Control(16)=   "fmeApportion"
      Tab(0).Control(16).Enabled=   0   'False
      Tab(0).Control(17)=   "ChkBx(3)"
      Tab(0).Control(17).Enabled=   0   'False
      Tab(0).ControlCount=   18
      TabCaption(1)   =   "Expensive Accommodation"
      TabPicture(1)   =   "Benaccom0.frx":001C
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "ChkBx(2)"
      Tab(1).Control(1)=   "TxtBx(18)"
      Tab(1).Control(2)=   "TxtBx(11)"
      Tab(1).Control(3)=   "TxtBx(9)"
      Tab(1).Control(4)=   "TxtBx(17)"
      Tab(1).Control(5)=   "TxtBx(14)"
      Tab(1).Control(6)=   "TxtBx(13)"
      Tab(1).Control(7)=   "TxtBx(3)"
      Tab(1).Control(8)=   "Lab(28)"
      Tab(1).Control(9)=   "Lab(29)"
      Tab(1).Control(10)=   "Lab(23)"
      Tab(1).Control(11)=   "Lab(24)"
      Tab(1).Control(12)=   "Lab(14)"
      Tab(1).Control(13)=   "Lab(18)"
      Tab(1).Control(14)=   "Lab(7)"
      Tab(1).Control(15)=   "Lab(8)"
      Tab(1).Control(16)=   "Lab(19)"
      Tab(1).ControlCount=   17
      TabCaption(2)   =   "Extra Expenses"
      TabPicture(2)   =   "Benaccom0.frx":0038
      Tab(2).ControlEnabled=   0   'False
      Tab(2).Control(0)=   "cmdN1A(2)"
      Tab(2).Control(1)=   "cmdN1A(1)"
      Tab(2).Control(2)=   "cmdN1A(0)"
      Tab(2).Control(3)=   "TxtBx(12)"
      Tab(2).Control(4)=   "TxtBx(10)"
      Tab(2).Control(5)=   "TxtBx(0)"
      Tab(2).Control(6)=   "TxtBx(16)"
      Tab(2).Control(7)=   "TxtBx(6)"
      Tab(2).Control(8)=   "TxtBx(5)"
      Tab(2).Control(9)=   "Lab(0)"
      Tab(2).Control(10)=   "Lab(30)"
      Tab(2).Control(11)=   "Lab(22)"
      Tab(2).Control(12)=   "Lab(12)"
      Tab(2).Control(13)=   "Lab(4)"
      Tab(2).Control(14)=   "Lab(27)"
      Tab(2).Control(15)=   "Lab(1)"
      Tab(2).Control(16)=   "Lab(9)"
      Tab(2).Control(17)=   "Lab(17)"
...
Private Sub Form_Load()
  ...
  Call SetupOpraInput(Lab(2), TxtBx(7))
...
'   .value(accom_RelevantDays_db) = 0
    ...
    .value(accom_OPRA_Ammount_Foregone_db) = 0
...
Private Function IBenefitForm2_BenefitOn() As Boolean
  ...
  TxtBx(7).Text = benefit.value(ITEM_OPRA_AMOUNT_FOREGONE)
End Function

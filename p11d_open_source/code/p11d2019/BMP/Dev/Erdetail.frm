...
Begin VB.Form F_EmployerDetails 
   ...
   Begin TabDlg.SSTab tab 
      ...
      Tab(2).Control(16)=   "TxtBx(17)"
      Tab(2).Control(16).Enabled=   0   'False
      Tab(2).Control(17)=   "TxtBx(16)"
      Tab(2).Control(17).Enabled=   0   'False
      Tab(2).Control(18)=   "TxtBx(26)"
      Tab(2).Control(18).Enabled=   0   'False
      Tab(2).Control(19)=   "TxtBx(25)"
      Tab(2).Control(19).Enabled=   0   'False
      Tab(2).Control(20)=   "TxtBx(15)"
      Tab(2).Control(20).Enabled=   0   'False
      Tab(2).Control(21)=   "TxtBx(14)"
      Tab(2).Control(21).Enabled=   0   'False
      Tab(2).Control(22)=   "TxtBx(24)"
      Tab(2).Control(22).Enabled=   0   'False
      Tab(2).Control(23)=   "TxtBx(23)"
      Tab(2).Control(23).Enabled=   0   'False
      Tab(2).Control(24)=   "TxtBx(22)"
      Tab(2).Control(24).Enabled=   0   'False
      Tab(2).Control(25)=   "TxtBx(21)"
      Tab(2).Control(25).Enabled=   0   'False
      Tab(2).Control(26)=   "TxtBx(20)"
      Tab(2).Control(26).Enabled=   0   'False
      Tab(2).Control(27)=   "TxtBx(19)"
      Tab(2).Control(27).Enabled=   0   'False
      Tab(2).Control(28)=   "TxtBx(18)"
      Tab(2).Control(28).Enabled=   0   'False
      Tab(2).Control(29)=   "ChkBx(3)"
      Tab(2).Control(29).Enabled=   0   'False
      Tab(2).Control(30)=   "ChkBx(4)"
      Tab(2).Control(30).Enabled=   0   'False
      Tab(2).Control(31)=   "ChkBx(5)"
      Tab(2).Control(31).Enabled=   0   'False
      Tab(2).ControlCount=   32
      TabCaption(3)   =   "General"
      TabPicture(3)   =   "Erdetail.frx":0054
      Tab(3).ControlEnabled=   0   'False
      Tab(3).Control(0)=   "ChkBx(2)"
      Tab(3).Control(0).Enabled=   0   'False
      Tab(3).Control(1)=   "ChkBx(1)"
      Tab(3).Control(1).Enabled=   0   'False
      Tab(3).Control(2)=   "ChkBx(0)"
      Tab(3).Control(2).Enabled=   0   'False
      Tab(3).Control(3)=   "TxtBx(4)"
      Tab(3).Control(3).Enabled=   0   'False
      Tab(3).Control(4)=   "TxtBx(3)"
      Tab(3).Control(4).Enabled=   0   'False
      Tab(3).Control(5)=   "TxtBx(5)"
      Tab(3).Control(5).Enabled=   0   'False
      Tab(3).Control(6)=   "TxtBx(13)"
      Tab(3).Control(6).Enabled=   0   'False
      Tab(3).Control(7)=   "TxtBx(6)"
      Tab(3).Control(7).Enabled=   0   'False
      Tab(3).Control(8)=   "TxtBx(7)"
      Tab(3).Control(8).Enabled=   0   'False
      Tab(3).Control(9)=   "TxtBx(8)"
      Tab(3).Control(9).Enabled=   0   'False
      Tab(3).Control(10)=   "TxtBx(9)"
      Tab(3).Control(10).Enabled=   0   'False
      Tab(3).Control(11)=   "TxtBx(10)"
      Tab(3).Control(11).Enabled=   0   'False
      Tab(3).Control(12)=   "TxtBx(31)"
      Tab(3).Control(12).Enabled=   0   'False
      Tab(3).Control(13)=   "TxtBx(32)"
      Tab(3).Control(13).Enabled=   0   'False
      Tab(3).Control(14)=   "TxtBx(33)"
      Tab(3).Control(14).Enabled=   0   'False
      Tab(3).Control(15)=   "Label16"
      Tab(3).Control(15).Enabled=   0   'False
      Tab(3).Control(16)=   "Label17"
      Tab(3).Control(16).Enabled=   0   'False
      Tab(3).Control(17)=   "Label18"
      Tab(3).Control(17).Enabled=   0   'False
      Tab(3).Control(18)=   "Lab(9)"
      Tab(3).Control(18).Enabled=   0   'False
      Tab(3).Control(19)=   "Lab(10)"
      Tab(3).Control(19).Enabled=   0   'False
      Tab(3).Control(20)=   "Lab(6)"
      Tab(3).Control(20).Enabled=   0   'False
      Tab(3).Control(21)=   "Lab(7)"
      Tab(3).Control(21).Enabled=   0   'False
      Tab(3).Control(22)=   "Lab(8)"
      Tab(3).Control(22).Enabled=   0   'False
      Tab(3).Control(23)=   "Lab(4)"
      Tab(3).Control(23).Enabled=   0   'False
      Tab(3).Control(24)=   "Lab(13)"
      Tab(3).Control(24).Enabled=   0   'False
      Tab(3).Control(25)=   "Lab(5)"
      Tab(3).Control(25).Enabled=   0   'False
      Tab(3).Control(26)=   "Lab(3)"

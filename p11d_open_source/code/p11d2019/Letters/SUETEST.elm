...
{normal}The following information will be provided to HMRC in relation to expenses, payments and
benefits provided to you by {companyname} between {TAX_YEAR_START} and {TAX_YEAR_END}.
...
{bold}Dispensations and PAYE Settlement Agreements (PSA)
{normal}Certain benefits and expenses are not included on the P11D information. These items are
not reported as they are included in a PSA or are covered by a dispensation agreed with HMRC. 
A dispensation is an agreement with HMRC not to report certain benefits as there is no tax payable
on them by our employees.  A PSA is an agreement for {companyname} to pay the tax due
on certain benefits provided on behalf of the employees.
...
uncertain whether an item is covered by a dispensation or PAYE settlement agreement please
contact me on {contactnum} for further information.

{bold}Contact Information
{normal}If you have any questions concerning the information contained in this letter please
contact me on {contactnum}.
...
{signatory}
{BOLD}Pensions & Benefits Director
...
2011/2012 DETAILS OF EXPENSES, PAYMENTS AND BENEFITS IN KIND:

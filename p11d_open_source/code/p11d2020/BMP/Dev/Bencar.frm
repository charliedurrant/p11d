...
Begin VB.Form F_CompanyCar 
   ...
   Begin TabDlg.SSTab tab 
      ...
      Tab(0).Control(7)=   "lblAccessories"
      Tab(0).Control(8)=   "Label4(16)"
      Tab(0).Control(9)=   "L_Data(19)"
      Tab(0).Control(10)=   "L_Data(7)"
      Tab(0).Control(11)=   "L_Data(8)"
      Tab(0).Control(12)=   "L_Data(9)"
      ...
      Tab(2).Control(1)=   "Op_Data(8)"
      Tab(2).Control(1).Enabled=   0   'False
      Tab(2).Control(2)=   "Op_Data(9)"
      Tab(2).Control(2).Enabled=   0   'False
      Tab(2).Control(3)=   "Op_Data(10)"
      Tab(2).Control(3).Enabled=   0   'False
      Tab(2).Control(4)=   "fraFuelBenefit"
      Tab(2).Control(4).Enabled=   0   'False
      Tab(2).Control(5)=   "CB_FuelType(1)"
      Tab(2).Control(5).Enabled=   0   'False
      Tab(2).Control(6)=   "Op_Data(12)"
   ...
   Begin VB.Frame fmeInput 
      ...
      Begin VB.ComboBox CB_Frequency 
         ...
         ForeColor       =   &H00000080&
         Height          =   315
         ItemData        =   "Bencar.frx":0100
         Left            =   2520
         List            =   "Bencar.frx":0102
         Style           =   2  'Dropdown List
         TabIndex        =   8
         Tag             =   "free,font"
         Top             =   3000
...
Private Sub Form_Load()
  ...
  Call AddComboItemAndItemData(CB_FuelType(1), S_PETROL, CCFT_PETROL)
  Call AddComboItemAndItemData(CB_FuelType(1), S_DIESEL, CCFT_DIESEL)
  Call AddComboItemAndItemData(CB_FuelType(1), S_EUROIVDIESEL, CCFT_EUROIVDIESEL)
  Call AddComboItemAndItemData(CB_FuelType(1), S_ELECTRICITY, CCFT_ELECTRIC)
  Call AddComboItemAndItemData(CB_FuelType(1), S_HYBRID, CCFT_HYBRID)
  Call AddComboItemAndItemData(CB_FuelType(1), S_GAS_ONLY, CCFT_GAS_ONLY)
  Call AddComboItemAndItemData(CB_FuelType(1), S_BIFUEL_CO2_FOR_GAS, CCFT_BIFUEL_WITH_CO2_FOR_GAS)
  Call AddComboItemAndItemData(CB_FuelType(1), S_BIFUEL_CONVERSION_OTHER_NOT_WITHIN_TYPE_B, CCFT_BIFUEL_CONVERSION_OTHER_NOT_WITHIN_TYPE_B)
  ...
  For i = 1 To p11d32.CurrentEmployer.CurrentEmployee.benefits.Count
    ...
    If Not (ben Is Nothing) Then
      If ben.BenefitClass = BC_COMPANY_CARS_F And Not ben Is benefit Then
        If ben.value(Car_AvailableTo_db) < benefit.value(Car_AvailableFrom_db) Then
...
Private Sub CO2StuffChanged()
   ...
   Select Case ccft
    Case CCFT_PETROL, CCFT_DIESEL, CCFT_HYBRID, CCFT_BIFUEL_WITH_CO2_FOR_GAS, CCFT_EUROIVDIESEL, CCFT_BIFUEL_CONVERSION_OTHER_NOT_WITHIN_TYPE_B, CCFT_GAS_ONLY
        bCO2Required = True
     Case CCFT_ELECTRIC
        bCO2Required = False
     Case Else
      Call Err.Raise(ERR_CAR_CO2, "Blah", "invalid fuel type")
   End Select

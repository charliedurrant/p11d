...
Public Const S_SERIAL_NUMBER_STANDARD = "P11DD847B378T4373420" 'Full functionality, all reports, emails etc.  Used for year-end (main) release.
Public Const S_SERIAL_NUMBER_INTRANET = "4687263T4S6P84662L20" 'As above with intranet publishing
Public Const S_SERIAL_NUMBER_SHORT = "P11DD8S4678V37746620" 'Reduced functionality (no printing (except P46, no employye letter etc.).  Used for b/f (minor) release.
Public Const S_SERIAL_NUMBER_DEMO = "P11DD366O659V3774620" 'Full functionality available for both releases

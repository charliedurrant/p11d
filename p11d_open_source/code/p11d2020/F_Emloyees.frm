   ...
   Begin VB.Frame fmeDetails 
      ...
      Begin VB.PictureBox Picture1 
         ...
         Begin VB.ComboBox CB_Gender 
            ...
            EndProperty
            Height          =   315
            ItemData        =   "F_Emloyees.frx":030A
            Left            =   675
            List            =   "F_Emloyees.frx":0317
...
Private Sub CB_Gender_Click()
  Call IFrmGeneral_CheckChanged(CB_Gender)
End Sub

Private Sub CB_Gender_LostFocus()
  Call IFrmGeneral_CheckChanged(CB_Gender)
End Sub

Private Sub CB_Gender_Validate(Cancel As Boolean)
  Call IFrmGeneral_CheckChanged(CB_Gender)
End Sub
...
Private Function IBenefitForm2_AddBenefitSetDefaults(ben As IBenefitClass) As Long
  With ben
    ...
    .value(ee_Selected) = False
    .value(ee_Gender_db) = S_GENDER_NA
    .value(ee_DOB_db) = UNDATED
  End With
End Function
...
Private Function IBenefitForm2_BenefitOn() As Boolean
  With benefit
    ...
    CB_Gender = .value(ee_Gender_db)
    TB_DATA(14).Text = IIf(.value(ee_DOB_db) = UNDATED, "", DateValReadToScreen(.value(ee_DOB_db)))
      ...
      Select Case .Name
        Case "TB_Data"
          Select Case .Index
            ...
            Case 14
              bDirty = CheckTextInput(.Text, benefit, ee_DOB_db)
            Case 1
        ...
        Case "chk_Class1AEmployeeIsNotSubjectTo"
          ...
          End If
        Case "CB_Status"
         bDirty = StrComp(IIf(benefit.value(ee_Director_db), S_DIRECTOR, S_STAFF), c.Text) <> 0
          ...
          End If
        Case "CB_Gender"
          bDirty = StrComp(benefit.value(ee_Gender_db), c.Text) <> 0
          If bDirty Then
            benefit.value(ee_Gender_db) = c.Text
          End If
        Case Else
          ECASE ("UNKNOWN CONTROL")
     End Select
...
Private Sub Form_Load()
  ...
  CB_Gender.Clear
  CB_Gender.AddItem S_GENDER_NA
  CB_Gender.AddItem S_GENDER_MALE
  CB_Gender.AddItem S_GENDER_FEMALE
  ...
  If Index = L_NI_NUMBER_TEXT_BOX_INDEX Then
    ...
    Else
      If p11d32.ValidateNINumberOnEmployeeScreen Then
        Valid = ValidateNI(sTextEntered, True) <> INVALID
      Else
        Valid = True
      End If
    End If

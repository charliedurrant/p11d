...
Begin VB.Form F_PrintOptions 
   ...
   Begin TabDlg.SSTab tab 
      ...
      Tab(2).Control(4)=   "chkA4ForcePrint"
      Tab(2).Control(4).Enabled=   0   'False
      Tab(2).Control(5)=   "cmdEmailSettings"
      Tab(2).Control(5).Enabled=   0   'False
      Tab(2).ControlCount=   6
      Begin VB.CommandButton cmdEmailSettings 
...
Private Sub chkA4ForcePrint_Click()
  p11d32.ReportPrint.A4ForcePrint = ChkBoxToBool(chkA4ForcePrint)
End Sub
  ...
  Select Case Index
    ...
    Case Else
      Select Case Index
        ...
        Case 3
          p11d32.ReportPrint.ExportOption = EXPORT_PDF
      End Select
  End Select
End Sub
...
Private Sub optReportExportEmployeeFileNameFields_Click(Index As Integer)
  Select Case Index
    Case -1

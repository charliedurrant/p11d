{normal}{P11D}{WORKING_PAPERS}
{companyname} PAYE reference: {payeref}
Personal reference: {pnumber} National Insurance number : {ninumber}

{normal}Dear {FIRSTNAME}

{bold}DETAILS OF EXPENSES, PAYMENTS AND BENEFITS {TAXYEAR}

{normal}Please find attached two files containing your {TAXYEAR} P11D return and accompanying 
Working papers. This information will be provided to HMRC in relation to
expenses, payments and benefits provided to you by {companyname}
between {TAX_YEAR_START} and {TAX_YEAR_END}.  A summary of this information is also provided
in the table below:
...
{normal}If you have any questions concerning the information contained in this email please

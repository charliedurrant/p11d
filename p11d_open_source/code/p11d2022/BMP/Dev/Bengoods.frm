...
Begin VB.Form F_AssetsAtDisposal 
   ...
   Begin VB.Frame fmeInput 
      ...
      Begin VB.Frame fmeAssets 
         ...
         Begin VB.CheckBox Chk 
            Alignment       =   1  'Right Justify
            Caption         =   "Is the asset computer related (s320 ITEPA 2003)?"
            ForeColor       =   &H00800000&
            Height          =   405
            Index           =   0
            Left            =   0
         ...
         Begin VB.Label lblWarning 
            Caption         =   "Note: all computer related items must be included in a single benefit item."
            ForeColor       =   &H000000FF&
            Height          =   405
            Left            =   0
            TabIndex        =   21
      ...
      Begin atc2valtext.ValText TxtBx 
         ...
         TXTAlign        =   2
      End
      Begin P11D2005.ValCombo cboIRDesc2 
         Height          =   315
         Left            =   1200
         TabIndex        =   23
         Tag             =   "free,font"
...
Private Sub chk_Click(Index As Integer)
  ...
  If Index = 0 Then
    lblWarning.Visible = (Chk(Index).value = vbChecked)
  End If
End Sub
...
Private Function IBenefitForm2_BenefitOn() As Boolean
  With benefit
    ...
    Chk(0).value = BoolToChkBox(.value(AssetsAtDisposal_ComputerRelated_db))

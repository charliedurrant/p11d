...
Public Const S_SERIAL_NUMBER_STANDARD = "P11DD847B378T4373421" 'Full functionality, all reports, emails etc.  Used for year-end (main) release.
Public Const S_SERIAL_NUMBER_INTRANET = "4687263T4S6P84662L21" 'As above with intranet publishing
Public Const S_SERIAL_NUMBER_SHORT = "P11DD8S4678V37746621" 'Reduced functionality (no printing (except P46, no employye letter etc.).  Used for b/f (minor) release.
Public Const S_SERIAL_NUMBER_DEMO = "P11DD366O659V3774621" 'Full functionality available for both releases
...
Public Enum BEN_CLASS
  ...
  BC_CLASS_1A_M '16
  [BC_M_START] = BC_CLASS_1A_M
  BC_NON_CLASS_1A_M '17
  BC_INCOME_TAX_PAID_NOT_DEDUCTED_M '18
  [BC_M_END] = BC_INCOME_TAX_PAID_NOT_DEDUCTED_M
  
  BC_TRAVEL_AND_SUBSISTENCE_N '19
  [BC_N_START] = BC_TRAVEL_AND_SUBSISTENCE_N

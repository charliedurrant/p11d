...
Begin VB.MDIForm MDIMain 
   ...
   Begin VB.Menu mnuTesting 
      Caption         =   "Testing"
      Begin VB.Menu mnuTestingGoogleSheet 
  ...
  If p11d32.VersionCheckFinished Then
    TimerVersionCheck.Enabled = False
     If ((p11d32.VersionCheckResult <> "1") And (p11d32.VersionCheckResult <> S_VERSION_CHECK_UNKNOWN)) Then
        Call MsgBox("A new version (" & p11d32.VersionCheckResult & ") of the software is available for download at: " & vbCrLf & vbCrLf & S_URL_DOWNLOADS & vbCrLf & vbCrLf & "Please contact our support at " & S_TELEPHONE & " if you have any questions.", vbInformation)
      End If
  End If

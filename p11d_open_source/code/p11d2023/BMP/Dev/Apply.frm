  ...
  With F_Employees.lb
    ...
    For i = 1 To lMax
      ...
      If ee.BenefitsLoaded Then
        lCDBEmployeeBenefitIndex = ee.benefits.ItemIndex(benefit)
      Else
...
Public Function ApplyCompanyDefinedBenefits() As Boolean
  Const S_OR  As String = " or "
  Const S_AND As String = " and "
  Dim l As Long, lMax As Long
  Dim ee As Employee
  Dim sBenCode As String
  Dim ben As IBenefitClass, oth As other
  ...
  For l = 1 To lMax
    If m_CDBAssinations(l).WasAssigned And Not m_CDBAssinations(l).Assigned Then
      ...
      Set benEE = ee
      If ee.BenefitsLoaded Then
        Call ee.benefits.Remove(benefit)

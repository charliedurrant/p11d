...
Public Property Get ObjectFromPtr(ByVal lPtr As Long) As BrowseForFolderClass
    Dim oThis As BrowseForFolderClass
...
Dim lR As Long
Dim pidl As Long
Dim cBF As BrowseForFolderClass
...
Public Function BrowseForFolderEx(ByVal hWndOwener As Long, Optional ByVal Initialdirectory As String, Optional ByVal Title As String) As String

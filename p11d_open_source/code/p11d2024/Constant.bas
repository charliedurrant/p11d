...
Public Const S_SERIAL_NUMBER_STANDARD = "P11DD847B378T4373424" 'Full functionality, all reports, emails etc.  Used for year-end (main) release.
Public Const S_SERIAL_NUMBER_INTRANET = "4687263T4S6P84662L24" 'As above with intranet publishing
Public Const S_SERIAL_NUMBER_SHORT = "P11DD8S4678V37746624" 'Reduced functionality (no printing (except P46, no employye letter etc.).  Used for b/f (minor) release.
Public Const S_SERIAL_NUMBER_DEMO = "P11DD366O659V3774624" 'Full functionality available for both releases

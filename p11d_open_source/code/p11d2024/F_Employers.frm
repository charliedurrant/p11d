...
Begin VB.Form F_Employers 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Top             =   0
      Width           =   10995
      Begin P11D2023.MyFolderBrowser fbWorkingDirectory 
         Height          =   375
         Left            =   0
         TabIndex        =   6
         Tag             =   "FREE,FONT"
      ...
      Begin VB.Label lblTitle 
         ...
         BackColor       =   &H80000005&
         BackStyle       =   0  'Transparent
         Caption         =   "support: p11d@gmail.com"
         BeginProperty Font 
            Name            =   "Verdana"
            Size            =   9
            Charset         =   0
         ...
         Width           =   2475
      End
      Begin VB.Label lblJuneRelease 
         Caption         =   "For P46(Car)s and data import"
         ForeColor       =   &H000000C0&
         Height          =   255
         Left            =   5505
         TabIndex        =   5
